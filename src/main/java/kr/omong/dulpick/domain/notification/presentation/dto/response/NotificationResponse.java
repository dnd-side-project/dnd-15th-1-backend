...
public record NotificationResponse(
        ...
        Long id,
        @Schema(
                description = "알림 표시와 화면 분기에 사용할 알림 유형. COUPLE_CONNECTED, COUPLE_DISCONNECTED, CONTENT_SAVE_MILESTONE, DATE_SCHEDULE_REMINDER, MARKETING 중 하나입니다.",
                allowableValues = {"COUPLE_CONNECTED", "COUPLE_DISCONNECTED", "CONTENT_SAVE_MILESTONE", "DATE_SCHEDULE_REMINDER", "MARKETING"},
                example = "CONTENT_SAVE_MILESTONE",
        ...
        String body,
        @Schema(
                description = "사용자가 알림을 선택했을 때 이동할 앱 화면 코드. COUPLE_STATUS, SAVED_CONTENTS, DATE_SCHEDULE, NOTICE 중 하나입니다.",
                allowableValues = {"COUPLE_STATUS", "SAVED_CONTENTS", "DATE_SCHEDULE", "NOTICE"},
                example = "SAVED_CONTENTS",
                requiredMode = Schema.RequiredMode.REQUIRED
        )
