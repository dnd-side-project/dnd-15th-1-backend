package kr.omong.dulpick.domain.feedback.presentation;
...
import kr.omong.dulpick.domain.feedback.presentation.dto.FeedbackRequest;
import kr.omong.dulpick.domain.feedback.presentation.dto.FeedbackResponse;
...
public class FeedbackController {
    ...
    @Operation(
            summary = "서비스 피드백 등록",
            description = "문의, 오류 제보, 기능 제안 또는 기타 의견을 접수합니다. 회원별 하루 10회까지 등록할 수 있습니다."
    )
    @PostMapping
