...
public record NoticeNotificationResponse(
        @Schema(description = "알림 작업 식별자", example = "8f4d1f6f-4d9b-4f5e-9c53-7d2c0e4b7a11") String campaignId,
        ...
        @Schema(description = "알림 작업 등록 시각", example = "2026-09-07T01:00:00Z") Instant queuedAt
) {
