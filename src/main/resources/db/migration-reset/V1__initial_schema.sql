-- Clean-database baseline for the post-reset schema.
-- This location is opt-in through the reset Spring profile.
-- It intentionally excludes production data updates and image backfills.
